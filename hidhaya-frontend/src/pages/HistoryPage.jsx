    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center animate-fade-in-up">
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Please login to view your chat history</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 overflow-y-auto h-full">
      <div className="flex items-center gap-3 mb-6 animate-fade-in-up">
        <Clock className="h-6 w-6" style={{ color: 'var(--text-accent)' }} />
        <h1 className="text-2xl font-bold" style={{ color: 'var(--text-primary)', fontFamily: "'Outfit', sans-serif" }}>Chat History</h1>
      </div>
      <ChatHistory />
    </div>
  )
